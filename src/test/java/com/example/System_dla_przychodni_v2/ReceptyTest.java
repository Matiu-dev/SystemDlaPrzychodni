...
public class ReceptyTest {

    private final String CREATE_USER_PATH = "src/test/java/com/example/System_dla_przychodni_v2/" +
            "requests/createUser.json";

    private final String CREATE_RECEPTY_PATH = "src/test/java/com/example/System_dla_przychodni_v2/" +
            "requests/createRecepty.json";
    ...
    public void userTestController() throws Exception {
        ...
        this.mockMvc
                .perform(post("/createRecepty")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(readFile(CREATE_RECEPTY_PATH)))
                .andDo(print())
                .andExpect(status().isCreated());
        ...
        this.mockMvc
                .perform(get("/getRecepty/1000"))
                .andDo(print())
                .andExpect(jsonPath("nazwaLeku").value("ibuprom"))
...
//        this.mockMvc
//                .perform(delete("/deleteRecepty/1000"))
//                .andDo(print())
//                .andExpect(status().isOk());
