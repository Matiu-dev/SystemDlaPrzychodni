...
CREATE TABLE `pacjent` (
  ...
  CONSTRAINT `pacjent_ibfk_1` FOREIGN KEY (`id_uzytkownika`) REFERENCES `uzytkownik` (`id_uzytkownika`),
  CONSTRAINT `pacjent_ibfk_2` FOREIGN KEY (`id_uzytkownika`) REFERENCES `uzytkownik` (`id_uzytkownika`)
)
